...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || "DARK-SILENCE-MD~DEsVDQiI#VgEGcqvEFL93WsnmUHTe3qQygMh2uAovJ3GGNEjhNOg",
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "923701164792",
    OWNER_NAME: process.env.OWNER_NAME || "➺khan_Baloch࿐",
    READ_CMD: process.env.READ_CMD || "true",
    BOT_NAME: process.env.BOT_NAME || "➺khan-S-MD",
